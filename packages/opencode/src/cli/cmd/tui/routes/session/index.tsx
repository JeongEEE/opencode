  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}pcode -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
...
function WebFetch(props: ToolProps<typeof WebFetchTool>) {
  const { t } = useI18n()
  return (
    <InlineTool icon="%" pending={t().tool_fetching_web} complete={props.input.url} part={props.part}>
...
function CodeSearch(props: ToolProps<typeof CodeSearchTool>) {
  ...
  return (
    <InlineTool icon="◇" pending={t().tool_searching_code} complete={props.input.query} part={props.part}>
