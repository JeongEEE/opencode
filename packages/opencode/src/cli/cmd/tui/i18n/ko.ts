...
export const ko: Translations = {
  ...
  tips_list: [
    ...
    "{highlight}.opencode/command/{/highlight}에 {highlight}.md{/highlight} 파일을 추가하여 재사용 가능한 커스텀 프롬프트를 정의할 수 있습니다",
    ...
    "{highlight}.opencode/agent/{/highlight}에 {highlight}.md{/highlight} 파일을 추가하여 특수화된 AI 페르소나를 만들 수 있습니다",
    ...
    "{highlight}.opencode/plugin/{/highlight}에 {highlight}.ts{/highlight} 파일을 추가하여 이벤트 훅을 만들 수 있습니다",
